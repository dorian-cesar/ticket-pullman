(function ($, window, document, undefined) {
  ...
  var methods = {
    ...
    update: function (arg) {
      ...
      if (options.percent.length > 0 && $percent) {
        ...
        console.warn("Error con el update del %");
        return false;
      }
      ...
      if (options.text.length > 0 && $text) {
        ...
        console.warn("Error con el texto a mostrar");
        return false;
      }
    },
  };
  ...
  Plugin.prototype.init = function () {
    ...
    element.prepend(
      '<div class="preloader"><div class="preloader-container"><div class="preloader-animation"></div></div></div>'
    );
    ...
    if (elementScrollHeight > preloaderHeight) {
      ...
      function fixAnimBlock() {
        ...
        preloaderPosition =
          Math.round(elementHeight / 2 - preloaderHeight / 2 + scrollTop) +
          "px";
